...
import com.example.goahead.makemyday.MainActivity;
import com.example.goahead.makemyday.R;
import com.example.goahead.makemyday.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        int numDays = 14;
        try {
            String url_s = "http://api.openweathermap.org/data/2.5/forecast/daily?q=" + locationQuery + "&mode="+format+"&units="+unit+"&cnt="+numDays+"&APPID=561f8515049db171c5bed8b8dbfb0669";
            url = new URL(url_s);
